...
adb shell pm uninstall --user 0 com.samsung.android.radiobasedlocation.manager
...
adb shell pm uninstall --user 0 com.samsung.android.radiobasedlocation
...
adb shell pm uninstall --user 0 com.samsung.android.slinkcloud
...
adb shell pm uninstall --user 0 com.samsung.android.app.multiwindow
...
adb shell pm uninstall --user 0 com.samsung.android.authservice
...
adb shell pm uninstall --user 0 com.samsung.android.nsdsvowifi
...
adb shell pm uninstall --user 0 com.samsung.android.fingerprint.service
...
adb shell pm uninstall -k --user 0 com.samsung.android.app.mhswrappertmo
...
adb shell pm uninstall --user 0 com.overlay.android.att
...
adb shell pm uninstall --user 0 com.att.mobile.android.vvm
...
adb shell pm uninstall --user 0 net.supertreat.solitaire
adb shell pm uninstall --user 0 com.dreamgames.royalmatch
adb shell pm uninstall --user 0 jp.gocro.smartnews.android
adb shell pm uninstall --user 0 com.tripledot.solitaire
adb shell pm uninstall --user 0 in.playsimple.wordtrip
adb shell pm uninstall --user 0 com.block.juggle
adb shell pm uninstall --user 0 com.tripledot.woodoku
adb shell pm uninstall --user 0 in.playsimple.tripcross
adb shell pm uninstall --user 0 com.particlenews.newsbreak
adb shell pm uninstall --user 0 com.google.android.apps.youtube.music
adb shell pm uninstall --user 0 com.google.android.apps.chromecast.app
adb shell pm uninstall --user 0 com.motorola.launcherconfig.overlay.tracfone
adb shell pm uninstall --user 0 com.motorola.android.providers.settings.tracfone.tonga
adb shell pm uninstall --user 0 com.motorola.launcherconfig.overlay.cricket
adb shell pm uninstall --user 0 com.motorola.launcherconfig.overlay.amxla
adb shell pm uninstall --user 0 com.motorola.launcherconfig.overlay.boost
adb shell pm uninstall --user 0 com.motorola.default.ringtones.overlay.metro.usku
adb shell pm uninstall --user 0 com.motorola.extensions.tracfone
adb shell pm uninstall --user 0 com.motorola.fmplayer
adb shell pm uninstall --user 0 com.motorola.android.systemui.overlay.att
adb shell pm uninstall --user 0 com.motorola.android.systemui.overlay.tmo
adb shell pm uninstall --user 0 com.motorola.android.systemui.overlay.usc
adb shell pm uninstall --user 0 com.motorola.android.systemui.overlay.vzw
adb shell pm uninstall --user 0 com.motorola.omadm.dish
adb shell pm uninstall --user 0 com.motorola.android.launcher.overlay.att.apptray
adb shell pm uninstall --user 0 com.motorola.spectrum.setup.extensions
adb shell pm uninstall --user 0 com.motorola.android.launcher.overlay.att
adb shell pm uninstall --user 0 com.motorola.android.launcher.overlay.amx
adb shell pm uninstall --user 0 com.motorola.default.ringtones.overlay.tmo.usku
adb shell pm uninstall --user 0 com.motorola.gamemode
adb shell pm uninstall --user 0 com.motorola.setup.overlay.tracfone
adb shell pm uninstall --user 0 com.motorola.comcast.settings.extensions
adb shell pm uninstall --user 0 com.motorola.sprint.setupext
adb shell pm uninstall --user 0 com.motorola.android.settings.overlay.vzw
adb shell pm uninstall --user 0 com.motorola.android.settings.overlay.att
adb shell pm uninstall --user 0 com.motorola.vzw.provider
adb shell pm uninstall --user 0 com.motorola.android.server.telecom.overlay.tmo
adb shell pm uninstall --user 0 com.motorola.android.launcher.overlay.cricket.apptray
adb shell pm uninstall --user 0 com.motorola.vzw.settings.extensions
adb shell pm uninstall --user 0 com.motorola.android.launcher.overlay.assurance.apptray
adb shell pm uninstall --user 0 com.motorola.android.server.telecom.overlay.gms.boost
adb shell pm uninstall --user 0 com.motorola.motocare
adb shell pm uninstall --user 0 com.motorola.mototour
adb shell pm uninstall --user 0 com.android.phone.over.common
adb shell pm uninstall --user 0 com.einnovation.temu
adb shell pm uninstall --user 0 com.united.mobile.android
...
adb shell pm uninstall --user 0 com.onedebit.chime
adb shell pm uninstall --user 0 com.tracfone.preload.accountservices
adb shell pm uninstall --user 0 com.pandora.android
adb shell pm uninstall --user 0 com.motorola.discovery
adb shell pm uninstall --user 0 com.squareup.cash
adb shell pm uninstall --user 0 com.google.android.apps.googleassistant
adb shell pm uninstall --user 0 com.magiear.handsfree.assistant
...
adb shell pm uninstall --user 0 com.sprint.ce.updater
adb shell pm uninstall --user 0 com.sprint.ms.cdm
adb shell pm uninstall --user 0 com.samsung.sprint.chameleon
adb shell pm uninstall --user 0 com.sprint.zone
adb shell pm uninstall --user 0 com.sprint.w.installer
adb shell pm uninstall --user 0 com.sprint.ecid
adb shell pm uninstall --user 0 com.sprint.care
...
adb shell pm uninstall --user 0 com.securityandprivacy.android.verizon.vms
...
adb shell pm uninstall --user 0 com.motorola.moto
...
adb shell pm uninstall --user 0 com.king.candycrushsodasaga
adb shell pm uninstall --user 0 com.att.deviceunlock
adb shell pm uninstall --user 0 com.att.tv
adb shell pm uninstall --user 0 net.peakgames.ginrummyplus
...
adb shell pm uninstall --user 0 com.hbo.hbonow
adb shell pm uninstall --user 0 com.acorns.android
adb shell pm uninstall --user 0 com.accuweather.android.lite
adb shell pm uninstall --user 0 com.accuweather.android
adb shell pm uninstall --user 0 com.adfone.aditup
adb shell pm uninstall --user 0 com.cricketwireless.minus
adb shell pm uninstall --user 0 com.firebase.honest
adb shell pm uninstall --user 0 com.mizmowireless.acctmgt
adb shell pm uninstall --user 0 com.asurion.android.mediabackup.vault.cricket
adb shell pm uninstall --user 0 com.cricketwireless.thescoop
adb shell pm uninstall --user 0 com.mizmowireless.vvm
adb shell pm uninstall --user 0 com.evenwell.camera2
adb shell pm uninstall --user 0 com.digitalturbine.cricketbar
adb shell pm uninstall --user 0 bubbleshooter.orig
adb shell pm uninstall --user 0 puzzle.game.find.differences
adb shell pm uninstall --user 0 com.pinterest
adb shell pm uninstall --user 0 com.newpubco.spades
adb shell pm uninstall --user 0 com.blackout.word
adb shell pm uninstall --user 0 com.mobilityware.BubbleShooter
...
adb shell pm uninstall --user 0 net.peakgames.toonblast
adb shell pm uninstall --user 0 net.peakgames.match
adb shell pm uninstall --user 0 com.apple.android.music
adb shell pm uninstall --user 0 com.moonactive.coinmaster
...
adb shell pm uninstall --user 0 com.opera.max.global
